...
import { TypePaiement, ITypePaiement } from '../../shared/models/type-paiement.model';
...
export class TypePaiementComponent implements OnInit {
    ...
    typePaiementsList: TypePaiement[];
    ...
    constructor(
        private _typePaiementService: TypePaiementService,
    ...
    loadAll(event?:any) {
      ...
      if(event){
        ...
        this._typePaiementService
          ...
          .subscribe(
            (res: HttpResponse<ITypePaiement[]>) => {
    ...
    protected paginateTypePaiement(data: ITypePaiement[], headers: HttpHeaders) {
    ...
    onDeleteConfirm(id: number): void {
      this._typePaiementService.delete(id).subscribe(response => {
