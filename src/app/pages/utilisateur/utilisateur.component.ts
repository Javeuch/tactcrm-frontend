...
import { Utilisateur, IUtilisateur } from '../../shared/models/utilisateur.model';
...
export class UtilisateurComponent implements OnInit {
      ...
      this._utilisateurService
        ...
        .subscribe(
          (res: HttpResponse<IUtilisateur[]>) => {
            ...
            this.paginateUtilisateur(res.body, res.headers);
          },
    ...
    protected paginateUtilisateur(data: IUtilisateur[], headers: HttpHeaders) {
    ...
    onDeleteConfirm(id: number): void {
      this._utilisateurService.delete(id).subscribe(response => {
        this.notify('success', 'success', 'Utilisateur  est supprimé');
        this.loadAll();
      });
  }
